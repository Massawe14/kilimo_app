...
class TTableActionButtons extends StatelessWidget {
  ...
  // Flag to determine wheather the view button is enabled
  final bool view;

  // Flag to determine wheather the edit button is enabled
  final bool edit;

  // Flag to determine wheather the delete button is enabled
  final bool delete;
      ...
      children: [
        ...
        if (edit)
          IconButton(
            ...
            icon: Icon(Iconsax.pen_add, color: TColors.accent),
          ),
        if (delete)
          IconButton(
