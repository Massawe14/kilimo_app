  ...
  factory TFormatException.fromCode(String code) {
    switch (code) {
      case 'invalid-email-format':
        return const TFormatException('The email address is invalid. Please enter a valid email address.');
      case 'invalid-phone-number-format':
        return const TFormatException('The provided phone number is invalid. Please enter a valid phone number.');
      ...
      default:
        return const TFormatException('An unexpected Format error occurred. Please try again.');
    }
  }
}