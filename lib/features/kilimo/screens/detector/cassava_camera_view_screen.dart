...
import '../../controllers/diseases/cassava/cassava_detection_controller.dart';
import 'disease_details_screen.dart';
import 'widgets/bounding_box_painter.dart';

class CassavaCameraView extends StatelessWidget {
  const CassavaCameraView({super.key});

  @override
  Widget build(BuildContext context) {
    final darkMode = THelperFunctions.isDarkMode(context);
    final CassavaDetectionController controller = Get.put(CassavaDetectionController());
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('cassava_disease_detection'.tr),
      ),
      body: SafeArea(
