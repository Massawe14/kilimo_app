            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    TTexts.beansCropTitle.tr,
                    style: Theme.of(context).textTheme.headlineMedium,
                  ),
                  const SizedBox(height: 8.0),
                  Text(
                    'beans_description'.tr,
                  ...
                  const SizedBox(height: TSizes.spaceBtwItems),
                  Text(
                    'beans_harvesting_description'.tr,
                    style: Theme.of(context).textTheme.bodyMedium,
                  ),
                  const SizedBox(height: TSizes.spaceBtwSections),
                  Text(
                  ...
                  const SizedBox(height: TSizes.spaceBtwItems),
                  Text(
                    'beans_pest_and_disease_description'.tr,
                    style: Theme.of(context).textTheme.bodyMedium,
                  ),
                  const SizedBox(height: TSizes.spaceBtwSections),
                  Text(
                  ...
                  const SizedBox(height: TSizes.spaceBtwItems),
                  Text(
                    'beans_common_problem_description'.tr,
                    style: Theme.of(context).textTheme.bodyMedium,
                  ),
                  const SizedBox(height: TSizes.spaceBtwSections),
                  Text(
