            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    TTexts.cassavaCropTitle.tr,
                    style: Theme.of(context).textTheme.headlineMedium,
                  ),
                  const SizedBox(height: 8.0),
                  Text(
                    'cassava_description'.tr,
                  ...
                  Text(
                    'cassava_planting_description'.tr,
                    style: Theme.of(context).textTheme.bodyMedium,
                  ),
                  const SizedBox(height: TSizes.spaceBtwSections),
                  Text(
                  ...
                  const SizedBox(height: TSizes.spaceBtwItems),
                  Text(
                    'cassava_harvesting_description'.tr,
                    style: Theme.of(context).textTheme.bodyMedium,
                  ),
                  const SizedBox(height: TSizes.spaceBtwSections),
                  Text(
                  ...
                  const SizedBox(height: TSizes.spaceBtwItems),
                  Text(
                    'cassava_storage_description'.tr,
                    style: Theme.of(context).textTheme.bodyMedium,
                  ),
                  const SizedBox(height: TSizes.spaceBtwSections),
                  Text(
                  ...
                  const SizedBox(height: TSizes.spaceBtwItems),
                  Text(
                    'cassava_pest_and_disease_description'.tr,
                    style: Theme.of(context).textTheme.bodyMedium,
                  ),
                  const SizedBox(height: TSizes.spaceBtwSections),
                  Text(
                  ...
                  const SizedBox(height: TSizes.spaceBtwItems),
                  Text(
                    'cassava_common_problem_description'.tr,
                    style: Theme.of(context).textTheme.bodyMedium,
                  ),
                  const SizedBox(height: TSizes.spaceBtwSections),
                  Text(
